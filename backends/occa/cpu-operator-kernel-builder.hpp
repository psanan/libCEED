...
#ifndef CEED_OCCA_CPUOPERATORKERNELBUILDER_HEADER
#define CEED_OCCA_CPUOPERATORKERNELBUILDER_HEADER

#include "operator-kernel-builder.hpp"

namespace ceed {
  namespace occa {
    class CpuOperatorKernelBuilder : public OperatorKernelBuilder {
     public:
      CpuOperatorKernelBuilder(const std::string &qfunctionFilename_,
